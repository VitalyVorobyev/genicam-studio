...
| ID | Task | Priority | Size | Status | ADR | Notes |
|----|------|----------|------|--------|-----|-------|
| IV-01 | Image Viewer layout redesign | P0 | M | planned | 006 | Split layout: canvas area + collapsible control sidebar. Replace current minimal viewer. |
| IV-02 | Acquisition control section | P0 | M | planned | 006 | Start/Stop, AcquisitionMode enum, frame counter display. |
